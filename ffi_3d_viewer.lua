...
-- =========================================================================
-- 1. C Declarations for Terminal, POSIX I/O, High-Res Clock, and Buffers
-- =========================================================================
ffi.cdef[[
    struct winsize {
...
-- =========================================================================
local function main()
    local interactive = ffi.C.isatty(STDIN_FILENO) == 1
    ...
    while true do
        ...
        if sleep_rem > 0.001 then
            local ts = ffi.new("timespec_t")
            ts.tv_sec = 0
            ts.tv_nsec = math.floor(sleep_rem * 1e9)
            -- poll with timeout handles sleep without extra syscalls
